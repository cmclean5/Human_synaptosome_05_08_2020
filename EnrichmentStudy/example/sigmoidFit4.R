...
## read in test data, built after first running enrichmentAnalysis.R
df <- read.delim("test.data.csv",sep="\t", header=T, check.names=F)

#rem <- c("fc2","lec","lec2","wt","wt2","sgG1_2","SVI","sgG1","fc","infomap","louvain")
#df  <- df[-match(rem,df[,1]),]
